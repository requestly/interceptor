...
PATHS.SETTINGS.SECRETS.MANAGE_PROVIDERS = {};
PATHS.SETTINGS.SECRETS.MANAGE_PROVIDERS.INDEX = "/manage-providers";
PATHS.SETTINGS.SECRETS.MANAGE_PROVIDERS.RELATIVE =
  PATHS.SETTINGS.SECRETS.RELATIVE + PATHS.SETTINGS.SECRETS.MANAGE_PROVIDERS.INDEX;
PATHS.SETTINGS.SECRETS.MANAGE_PROVIDERS.ABSOLUTE =
  PATHS.SETTINGS.SECRETS.ABSOLUTE + PATHS.SETTINGS.SECRETS.MANAGE_PROVIDERS.INDEX;
...
// API Client - Example
PATHS.API_CLIENT.EXAMPLE = {};
PATHS.API_CLIENT.EXAMPLE.INDEX = "example/:exampleId";
PATHS.API_CLIENT.EXAMPLE.RELATIVE = joinPaths(PATHS.API_CLIENT.RELATIVE, PATHS.API_CLIENT.EXAMPLE.INDEX);
PATHS.API_CLIENT.EXAMPLE.ABSOLUTE = joinPaths(PATHS.API_CLIENT.ABSOLUTE, PATHS.API_CLIENT.EXAMPLE.INDEX);
