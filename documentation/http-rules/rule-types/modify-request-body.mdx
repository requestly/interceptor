...
<Steps>
  ...
  <Step title="Choose Static or Programmatic Modification">
    ...
    <Note>
      On the **desktop app**, this JavaScript runs inside a secure sandbox by default — it has no
      filesystem or system access. If your script needs Node.js APIs such as `require`, `fs`, or
      `process`, enable <a target="_blank" href="/interceptor/desktop-app/developer-script-mode">**Developer Script Mode**</a>
